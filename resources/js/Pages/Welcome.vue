          ...
          <form class="mb-10" action="/proceguir" method="POST">
            ...
            <div class="flex flex-grow mb-10">
              <input
                type="text"
                name="cnes"
                class="w-full border-transparent rounded shadow-lg bg-[#F3F3F3]"
                placeholder="CNES"
              />
            </div>
            <div
              v-if="$page.props.errado.erro != ''"
            ...
            <div class="flex">
              ...
              <div class="flex-grow mr-4">
                ...
                <div
                  class="g-recaptcha m-3"
                  data-sitekey="6LdHH5UUAAAAAIrf3rzUZlYRiE9U4EdYfl8twDye"
                ></div>
              </div>
              <div class="">
